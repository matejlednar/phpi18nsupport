...
<html lang="en">
    <head>
        <title><? $app->showText("title"); ?></title>
        <meta charset="utf-8">
    ...
    <body>
        <div class="container">
            <nav class="navbar navbar-toggleable-md navbar-light bg-faded">
                ...
                <a class="navbar-brand" href="#"><? $app->showText("brand"); ?></a>
                <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                    <ul class="navbar-nav">
                        <li class="nav-item active">
                            <a class="nav-link" href="#"><? $app->showText("home"); ?> <span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#"><? $app->showText("about"); ?></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#"><? $app->showText("services"); ?></a>
                        </li>
